...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, data_dir, image_size):
        ...
        label_file = open(os.path.join(self.data_dir, 'labels', 'labels_v3.0.csv'))
    ...
    def __getitem__(self, item):
        ...
        image_file_name, color, style, season, category = data.split(',')
        ...
        return [transform(image), self.color_label[color], self.style_label[style], self.season_label[season], self.category_label[category]]
